...
const Auth = () => { 
  ...
  return (
    <div className="relative h-full w-full bg-[url('/images/frontPage.jpg')] bg-no-repeat bg-center bg-fixed bg-cover">
        <div className="bg-black w-full h-full lg:bg-opacity-50">
            <nav className="px-12 py-5">
                <img src="/images/logo4.png" alt="" className="h-12" />
            </nav>
            <div className="flex justify-center">
                ...
                />
                    ...
                    <button onClick={variant === 'login' ? login : register} className="bg-yellow-600 py-3 text-white rounded-md w-full mt-10 hover:bg-blue-700 transition">
